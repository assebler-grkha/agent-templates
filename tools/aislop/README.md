# aislop (Antigravity Agentic Fork)

> **Fork Notice**: This is an agentic-optimized fork of upstream [scanaislop/aislop](https://github.com/scanaislop/aislop) (MIT License).
>
> **Enhancements in this fork**:
> - **Agent Markers (`AGENT:*`)**: Recognizes `AGENT:MOCK`, `AGENT:STUB`, `AGENT:HARDCODE`, and `AGENT:TEMP` as tracked technical debt (exempt from uncompleted TODO penalties).
> - **Smart Debt Diagnostics**: Flags unmarked stubs, dummy/mock data structures, and hardcoded localhost addresses, guiding AI agents with exact format recommendations.
> - **Original Project**: [https://github.com/scanaislop/aislop](https://github.com/scanaislop/aislop) by Kenny Olawuwo & contributors.
