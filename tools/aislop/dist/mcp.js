...
const CsharpLintSchema = z$1.object({
	projectEvaluation: z$1.boolean().default(false),
	jb: z$1.boolean().default(true),
	roslynator: z$1.boolean().default(true),
	jbSeverityFloor: z$1.enum([
		"ERROR",
		"WARNING",
		"SUGGESTION",
		"HINT"
	]).default("WARNING"),
	jbExcludeTypes: z$1.array(z$1.string()).default(() => ["InconsistentNaming"]),
	jbProjects: z$1.string().optional()
});
const CppLintSchema = z$1.object({
	cppcheck: z$1.boolean().default(true),
	clangTidy: z$1.boolean().default(true),
	cppcheckEnable: z$1.string().default("warning,performance,portability"),
	jb: z$1.boolean().default(false),
	jbProjects: z$1.string().optional(),
	jbSeverityFloor: z$1.enum([
		"ERROR",
		"WARNING",
	...
	jbExcludeTypes: z$1.array(z$1.string()).default(() => [])
});
...
const ScoringSchema = z$1.object({
	...
	smoothing: z$1.number().nonnegative().default(5),
